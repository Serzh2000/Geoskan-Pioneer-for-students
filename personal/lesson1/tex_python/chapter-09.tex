...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Локальная камера и видеопоток для трекинга}]{../pioneer-python-example/PioneerHumanTracking/cam1.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Полный сценарий отслеживания человека}]{../pioneer-python-example/PioneerHumanTracking/human-tracking.py}
