...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Синхронный полёт двух дронов}]{../pioneer-python-example/group_flight_examples/swarm_OPT.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Синхронный полёт с PiZero и MAVLink-портом}]{../pioneer-python-example/group_flight_examples/swarm_OPT_PiZero.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Круговой роевой полёт с фазовым сдвигом}]{../pioneer-python-example/group_flight_examples/swarm_circle_IRNAV.py}
