...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Ручное управление через WASD и RC-каналы}]{../pioneer-python-example/WASD_flight.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Управление Lua-скриптом на борту}]{../pioneer-python-example/LUA_script_start.py}
