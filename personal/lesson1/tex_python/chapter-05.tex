...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Маршрут по массиву точек с кадрами камеры}]{../pioneer-python-example/mission_examples/mission_with_frames.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Окружность по дискретным точкам}]{../pioneer-python-example/mission_examples/circle_flight.py}
