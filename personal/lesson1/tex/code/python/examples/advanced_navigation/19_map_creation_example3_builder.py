...
if __name__ == "__main__":
    ...
    my_map.save_json("field_map.json")
    my_map.save_pdf("field_map.pdf", trajectory=trajectory)
    
    # Export Clever 4 style artifacts
    my_map.save_yaml("clever_map.yaml")
    my_map.save_png_grid("clever_map_4096.png", resolution_px=4096)
    ...
    with open("map_config.json", 'w') as f:
        ...
        print("Config saved to map_config.json")
