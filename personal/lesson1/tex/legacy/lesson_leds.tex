...
Используйте асинхронные таймеры, глобальные переменные для таймеров и состояний, полный проход по индексам \verb|0..3|. Формулировки ниже предельно простые; рядом указаны примеры для ориентира.
\subsection{Базовые алгоритмы}
\begin{enumerate}
  \item \textbf{Зелёный свет.} Включите \verb|{0,1,0}| на всех индексах \verb|0..3|. Подсказка: пример инициализации в разделе «Адресация и буфер».
...
\begin{enumerate}[resume]
  ...
  \item \textbf{Чётность индекса.} Чётные — красный, нечётные — синий для всех \verb|0..3|. Подсказка: \verb|i % 2|.
