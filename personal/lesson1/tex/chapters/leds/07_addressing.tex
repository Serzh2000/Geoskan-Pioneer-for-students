...
Мы выяснили, что в буфере 4 ячейки (\texttt{0..3}). На плате квадрокоптера вы видите 4 больших светодиода.
...
\begin{tikzpicture}[scale=1.2]
    ...
    \node[red, align=center, below=0.5cm] at (0,-1.5) {Светодиоды базы\\(индексы 0-3)};
...
\hline
\rowcolor{GeoskanBlue!20} \textbf{Индекс} & \textbf{Расположение (Например: Передний левый)} \\
\hline
0 & \dotfill \\
\hline
1 & \dotfill \\
