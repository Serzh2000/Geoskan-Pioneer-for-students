...
Мы выяснили, что в буфере 25 ячеек (\texttt{0..24}). На плате квадрокоптера вы видите светодиодную линейку из 25 элементов.
...
\begin{enumerate}
    ...
    \item Повторите для индексов \texttt{1}, \texttt{2}, \texttt{3}, \dots, \texttt{24}.
...
\begin{tikzpicture}[scale=1.2]
    ...
    \node[red, align=center, below=0.5cm] at (0,-1.5) {Светодиодная линейка\\(индексы 0-24)};
