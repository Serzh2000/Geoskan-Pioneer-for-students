...
\begin{itemize}
  ...
  \begin{itemize}
      \item \textit{Пример:} \texttt{local leds = Ledbar.new(4)}
  \end{itemize}
...
Обратите внимание: нумерация светодиодов начинается с \textbf{нуля}. Если вы создали ленту на 4 элемента, допустимые индексы — от 0 до 3. Попытка обратиться к индексу 4 приведёт к ошибке.
\end{warnbox}
