...
\begin{codefile}{examples/chapter_04/loops_sum.lua}
\end{codefile}
\begin{codefile}{examples/chapter_04/loops_while.lua}
\end{codefile}
\begin{codefile}{examples/chapter_04/loops_iterators.lua}
\end{codefile}
\paragraph{Пояснения.}
...
- Для обхода диапазона индексов, используемых в светодиодной линейке, применяйте \verb|for i=0,3 do|.
...
\begin{enumerate}
  ...
  \item Пройдитесь по индексам \verb|0..3| и заполните таблицу \verb|idx| значениями \verb|i|.
