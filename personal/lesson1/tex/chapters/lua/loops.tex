...
\begin{codefile}{lua/examples/chapter_04/loops_sum.lua}
\end{codefile}
\begin{codefile}{lua/examples/chapter_04/loops_while.lua}
\end{codefile}
\begin{codefile}{lua/examples/chapter_04/loops_iterators.lua}
\end{codefile}
\paragraph{Пояснения.}
