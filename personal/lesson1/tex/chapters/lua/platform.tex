...
- \verb|Ledbar.new(N)| — создание объекта управления (обычно \verb|N=4|).
- \verb|leds:set(i, r, g, b)| — установка цвета светодиода \verb|i|. Параметры \verb|r,g,b| — от 0.0 до 1.0.
- \verb|Timer.new(period, fn)| — создание периодического таймера.
- \verb|Timer.callLater(delay, fn)| — отложенный вызов функции.
...
\begin{enumerate}
    ...
    \begin{codefile}{examples/chapter_04/lua_platform_infinite_loop.lua}
    \end{codefile}
...
\end{infobox}
\begin{codefile}{examples/chapter_04/lua_platform_leds_unpack.lua}
\end{codefile}
\begin{codefile}{examples/chapter_04/lua_platform_timer.lua}
\end{codefile}
\begin{codefile}{examples/chapter_04/lua_platform_blink.lua}
\end{codefile}
