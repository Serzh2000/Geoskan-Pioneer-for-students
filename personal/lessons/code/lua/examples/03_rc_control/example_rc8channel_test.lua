...
-- Инструкция по настройке: настроить 8 канал на пульте в SwA. Поставить квадрокоптер, нажать кнопку запуска скрипта (квадрокоптер должен издать звуковой сигнал), отойти на безопасное расстояние. Переключить тумблер SwA вниз, после запуска моторов поднять тумблер вверх. Коптер начнет лететь по заданным координатам.


-- Упрощение вызова функции распаковки таблиц из модуля tabl
