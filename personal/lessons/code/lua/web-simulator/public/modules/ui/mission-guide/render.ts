                    ...
                    <div class="guide-workbench-layout__main">
                        <section class="guide-panel-card">
                            <div class="guide-panel-card__top">
                                ...
                                <div class="guide-panel-card__text">Соберите цепочку и нажмите одну кнопку. Если код исполнимый, сценарий запустится сразу; учебные замечания при этом останутся справа.</div>
                                </div>
