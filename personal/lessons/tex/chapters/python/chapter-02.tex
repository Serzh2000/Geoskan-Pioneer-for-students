...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Минимальное управление моторами и просмотром видеопотока}]{../code/python/examples/test.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Взлёт, выход на точку и посадка}]{../code/python/examples/mission_examples/PiZero_test.py}
