...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Запуск и остановка видеопотока}]{../code/python/examples/camera_examples/camera_stream.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Получение кадров с камеры}]{../code/python/examples/camera_examples/get_frames_from_camera.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Калибровка камеры по шахматной доске}]{../code/python/examples/camera_examples/camera_calibration.py}
