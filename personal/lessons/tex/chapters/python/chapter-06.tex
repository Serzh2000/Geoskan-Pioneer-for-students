...
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Ручное управление через WASD и RC-каналы}]{../code/python/examples/02_pioneer_sdk/WASD_flight.py}
\lstinputlisting[style=GeoskanStyle,language=pythoncustom,caption={Управление Lua-скриптом на борту}]{../code/python/examples/02_pioneer_sdk/LUA_script_start.py}
