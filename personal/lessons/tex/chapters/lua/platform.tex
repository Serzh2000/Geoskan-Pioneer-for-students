...
\begin{enumerate}
    ...
    \begin{codefile}{lua/examples/04_language/lua_platform_infinite_loop.lua}
    \end{codefile}
...
\end{infobox}
\begin{codefile}{lua/examples/04_language/lua_platform_leds_unpack.lua}
\end{codefile}
\begin{codefile}{lua/examples/04_language/lua_platform_timer.lua}
\end{codefile}
\begin{codefile}{lua/examples/04_language/lua_platform_blink.lua}
\end{codefile}
