...
\begin{itemize}
  \item Понять RGB‑модель и адресацию индексов \texttt{0..24}.
...
Вы закрепили работу с буфером 25 индексов, научились строить анимации на таймерах, корректно реагировать на системные события, составлять проверяемые алгоритмы индикации. Эти приёмы будут применяться при проектировании автономных миссий.
