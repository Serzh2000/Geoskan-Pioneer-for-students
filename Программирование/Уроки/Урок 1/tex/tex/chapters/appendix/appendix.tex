...
\begin{itemize}
  \item \texttt{ap.push(Ev.MCE\_PREFLIGHT)}, \texttt{ap.push(Ev.MCE\_TAKEOFF)}, \texttt{ap.push(Ev.MCE\_LANDING)}, \texttt{ap.push(Ev.ENGINES\_DISARM)}.
...
\begin{itemize}
  ...
  \item Диапазоны: индексы линейки \texttt{0..24}; буфер \texttt{Ledbar.new(25)}.
\end{itemize}
